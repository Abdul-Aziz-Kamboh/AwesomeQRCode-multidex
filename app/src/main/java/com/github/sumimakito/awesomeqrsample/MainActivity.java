        ...
        etLogoScale.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
              ...
              //  textView.setText( yourprogress + " km");// + seekBar.getMax());
                ...
                Toast.makeText(MainActivity.this, "Value "+yourprogress, Toast.LENGTH_SHORT).show();
            }
...
//Log.d("logScale","value is "+dotScl);
        ...
        btGenerate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Scroll Down To View It and Pick Dots Color", Toast.LENGTH_SHORT).show();
                try {
    ...
    if (ckbAutoColor.isChecked()) {
        ...
        Toast.makeText(MainActivity.this, "Error:Auto Color Checkbox status is :" + ckbAutoColor.isChecked(), Toast.LENGTH_SHORT).show();
    }
